    ...
    return (
        ...
        >
            <div className="relative w-full h-40">
                {/* OUTLET badge */}
                <div className="absolute -left-4 -top-2 w-12 h-12 bg-black text-white text-[10px] font-bold rounded-full flex items-center justify-center shadow">
                    OUTLET
                </div>
            ...
            <div className="text-sm space-y-1">
                <div>
                    <span className="font-semibold text-gray-500">Ord. pris: </span>
                    <span className="line-through text-gray-400">{originalPrice}:-</span>
                </div>
                <div>
                    <span className="font-semibold text-red-600">Outlet-pris: </span>
