            ...
            <div className="max-w-6xl mx-auto px-4 mb-6 relative">
                <div
                    ...
                    className={`transition-all duration-300 ease-in-out transform ${
                        showCart ? "max-h-[1000px] opacity-100 scale-100" : "max-h-0 opacity-0 scale-y-95"
                ...
                <section className="bg-white rounded-md shadow p-6 mx-4 md:mx-auto max-w-4xl">
                    ...
                    <div className="flex gap-4 mb-6">
                        <button
                            ...
                            className={`px-4 py-2 rounded ${isPrivate ? "bg-blue-600 text-white" : "bg-gray-200"}`}
                        >
                            Privatkund
                        </button>
                        <button
                    ...
                    {/* User info */}
                    <div className="mb-6">
                        <h2 className="text-xl font-semibold mb-2">Dina uppgifter</h2>
                    ...
                    {/* Payment options */}
                    <div className="mb-6">
                        <h2 className="text-xl font-semibold mb-2">Betalning</h2>
                        <label className="flex items-center gap-2">
            ...
            {orderComplete && (
                <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
                    <div className="bg-white p-8 rounded-lg shadow-xl max-w-md w-full text-center">
                        <h2 className="text-2xl font-bold mb-4">Tack så mycket för din beställning!</h2>
                        <p className="mb-4">Ditt kvitto skickas till <strong>{user?.email}</strong></p>
                        <p className="text-lg font-semibold">Total: {totalPrice.toFixed(2)} {currency}</p>
                        <button
                            onClick={() =>{
                                clearCart();
